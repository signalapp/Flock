...
public abstract class Optional<T> implements Serializable {
   ...
   * reference; otherwise returns {@link org.anhonesteffort.flock.util.guava.Optional#absent}.
   */
  ...
  /**
   * Returns an immutable singleton {@link java.util.Set} whose only element is the contained instance
   * if it is present; an empty immutable {@link java.util.Set} otherwise.
   *
   * @since 11.0
   */
   ...
   * {@link org.anhonesteffort.flock.util.guava.Optional#absent} is returned. If the function returns {@code null}, a
   ...
   * skipping over occurrences of {@link org.anhonesteffort.flock.util.guava.Optional#absent}. Iterators are unmodifiable and are
   * evaluated lazily.
   *
